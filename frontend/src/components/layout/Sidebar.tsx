    ...
    <div className="w-72 bg-royal-blue min-h-screen flex flex-col text-white p-6 justify-between border-r border-white/10 shadow-2xl relative z-50">
      ...
      <div className="space-y-6">
        <div className="p-6 bg-white/5 rounded-3xl border border-white/5 relative overflow-hidden group">
            ...
            <p className="text-xs text-white/40 mb-1 uppercase tracking-widest font-semibold">Aktif Kullanıcı</p>
            <p className="text-sm font-bold text-white mb-2">Semih Çetin</p>
            <p className="text-[10px] text-gold/80 font-medium px-2 py-1 bg-gold/10 rounded-lg inline-block border border-gold/20">Müdür</p>
        </div>
